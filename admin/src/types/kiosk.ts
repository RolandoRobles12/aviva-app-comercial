...
/**
 * Tipo de producto (código del producto)
 * Los productos se gestionan dinámicamente desde la colección 'products' en Firestore
 */
...
/**
 * DEPRECATED: Los productos ahora se gestionan dinámicamente desde Firestore (colección 'products')
 * Este constante se mantiene solo para referencia y será removido en futuras versiones
 */
